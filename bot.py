...
async def start(update: Update, context: ContextTypes.DEFAULT_TYPE) -> None:
    ...
    welcome_text = (
        ...
        "Чувствую, что ты тоже. Избавься от бесполезной болтовни, "
        "уничтожь календарь со встречами и вспомни: жизнь нужна, чтобы путешествовать, "
        "влюбляться, есть, смотреть фильмы, делать отжимания от пола или залипать в рилзах. "
        "Все это явно лучше работы."
    )
